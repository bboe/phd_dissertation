...
video can also be integrated into \sprogram{s}.  Scratch was designed to allow
...
\sprogram{s} are challenging to analyze.
...
\emph{main} point of execution.  Instead, \sprogram{s} might begin when a
