...
their \sprogram{s} for potential problems, and (2)~summative
...
framework in Section~\localref{sec:framework}. The Hairball plugins we
developed for our analysis are described in Section~\localref{sec:plugins}. We
describe our methodology and results in Section~\localref{sec:methodology} and
