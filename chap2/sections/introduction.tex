...
our Hairball framework in Section~\localref{sec:framework}. The Hairball
plugins we developed for our analysis are described in
Section~\localref{sec:plugins}. We describe our methodology in
Section~\localref{sec:methodology}, and results in
