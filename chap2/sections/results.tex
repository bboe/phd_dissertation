...
analysis, both false positives and false negatives represent the inaccuracies
of manual assessment. For Hairball, false negatives can be considered warnings,
...
\caption{Compares the initialization instance labels. Note that this analysis
  ...
  negatives. Note that for this concept there are exactly 348 possible
  instances as each of the fifty-eight \sprogram{s} have six attributes that
  require initialization if modified.}
...
sixty-five instances that Hairball and the initial manual analysis labeled
differently, Hairball was accurate for thirty-two of the instances based on the
ground truth, i.e., our second manual analysis. Many of the remaining
