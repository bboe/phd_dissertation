...
provides an extendable framework for automatically analyzing \sprogram{s}.  In
addition, we provide an initial set of plugins that analyze the implementation
of \sprogram{s} for competence in four areas: initialization, broadcast and
...
to utilize Hairball for formative assessment of individual \sprogram{s}.
