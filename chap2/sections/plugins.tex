...
static analysis.  The plugins were designed to analyze \sprogram{s} submitted
...
synchronization between say and sound blocks, and creation of complex
...
for individual developers of \sprogram{s} and for others who are tasked with
analyzing numerous \sprogram{s}.
...
\caption{Lists the five categories of initial state, and provides a subset of
  the relative and absolute modification blocks for each category.}
...
execution starts at ``main''.  \sprogram{s} have no such globally defined
...
\sprogram{'s} scripts modifies the attribute. Thus, the challenge is
...
not demonstrate competence in the computer science concept of loops. Finally,
if the \sprogram{} is missing any critical element, e.g., repetition, it is
labeled incomplete.
