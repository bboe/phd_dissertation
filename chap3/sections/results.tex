...
\begin{figure}[!t]
\centering \includegraphics[width=5.25in]{graphs/race_condition_Sequential1.eps}
...
\begin{figure}[!t]
\centering \includegraphics[width=5.25in]{graphs/race_condition_Sequential2.eps}
\caption{Shows the breakdown of students affected by the race condition issue
  in Scratch for \stwo{}.}
