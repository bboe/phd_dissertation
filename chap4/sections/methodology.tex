...
While the submission system supports both programming assignments and
\emph{fill in the blank}-type assignments, we only consider programming
...
the quarter, the students made submissions using the archaic submission system
