...
\begin{figure}[!t]
\centering
\includegraphics[width=5.25in]{graphs/Submissions_by_Time_of_Day.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=5.25in]{graphs/Submissions_by_Time_of_Day_Near_Deadline.eps}
...
there is little difference in the figure shape prior to \AM{11}, there is only
