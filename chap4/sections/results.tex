...
Figure~\localref{fig:relative_start_time} plots the number of hours between a
...
in days prior to the deadline at \PM{4}. The amount of work significantly
dropped at \PM{6} and remained nearly consistent until \AM{1}. Although all of
their assignment deadlines were at \PM{6}, they attributed the peak in work
between \PM{4} and \PM{6} as the time that students preferred to work and thus
...
\caption{Visualizes the time of day submissions were made excluding submissions
  ...
  starting at \PM{9} that continues through midnight.}
...
Figure~\localref{fig:by_time_far} that were made fewer than twenty-four hours
...
to their assignment deadline. Figure~\localref{fig:by_time_near} confirms that
hypothesis. While there is little difference in the figure shape prior to
\AM{11}, there is only a slight increase in work during the \AM{11} to \PM{3}
range. A sharp spike in submissions occurs at \PM{4} and has a gradual decrease
until \PM{6}. This decrease in submissions occurs in both figures, and we
...
work session. Figure~\localref{fig:session_duration} shows that there is a
...
Figure~\localref{fig:window_size}. Despite this correlation, we cannot
...
delay. Figure~\localref{fig:delay_improvement} shows that there is a
