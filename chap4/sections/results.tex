...
\spacco{} arbitrarily chose a window size of twenty
...
data. Figure~\localref{fig:work_sessions} shows the effect of increasing the
...
of the window sizes highlighted in Figure~\localref{fig:window_size}.
